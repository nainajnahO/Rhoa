"""BiLSTM Stock Predictor - TensorFlow/Keras Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_bilstm.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_bilstm.csv'

def create_sequences(X, y, timesteps):
    """Create sliding window sequences for BiLSTM"""
...
def main():
    ...
    ax.set_title(f'{STOCK_NAME} - BiLSTM Buy Signals', fontsize=16, fontweight='bold', pad=20)
