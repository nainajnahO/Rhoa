"""CNN-LSTM Hybrid Stock Predictor - TensorFlow/Keras Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_cnnlstm.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_cnnlstm.csv'

def create_sequences(X, y, timesteps):
    """Create sliding window sequences for CNN-LSTM"""
...
def main():
    ...
    ax.set_title(f'{STOCK_NAME} - CNN-LSTM Buy Signals', fontsize=16, fontweight='bold', pad=20)
