"""CNN1D Stock Predictor - TensorFlow/Keras Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_cnn1d.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_cnn1d.csv'

def create_sequences(X, y, timesteps):
    """Create sliding window sequences for CNN1D"""
...
def create_model(n_features):
    model = Sequential([
        Conv1D(64, kernel_size=3, activation='relu', padding='same', input_shape=(TIMESTEPS, n_features)),
...
def main():
    ...
    ax.set_title(f'{STOCK_NAME} - CNN1D Buy Signals', fontsize=16, fontweight='bold', pad=20)
