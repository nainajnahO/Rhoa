"""
GradientBoosting Stock Predictor - Fixed Implementation

This script trains a GradientBoosting model using proper time series validation to prevent data leakage.
...
Usage:
    python experimental/gradientboosting_predictor.py
"""
...
# GradientBoosting Hyperparameters (optimized for accuracy)
...
# Visualization
OUTPUT_PLOT_PATH = 'predictions_gradientboosting.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_gradientboosting.csv'
...
def walk_forward_validation(df, features, n_splits, min_train_size):
    ...
    for split_num in range(n_splits):
        ...
        model = GradientBoostingClassifier(**GRADIENTBOOSTING_PARAMS)
...
def main():
    print("="*80)
    print("GRADIENTBOOSTING STOCK PREDICTOR - FIXED IMPLEMENTATION")
    print("="*80)
    ...
    final_model = GradientBoostingClassifier(**GRADIENTBOOSTING_PARAMS)
    ...
    # Formatting
    title = f'{STOCK_NAME} - GradientBoosting Buy Signals (Walk-Forward + Future)'
