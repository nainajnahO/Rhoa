"""
XGBoost Stock Predictor - Fixed Implementation

This script trains an XGBoost model using proper time series validation to prevent data leakage.
...
Usage:
    python experimental/xgboost_predictor.py
"""
...
# Visualization
OUTPUT_PLOT_PATH = 'predictions_xgboost.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics.csv'
...
def main():
    print("="*80)
    print("XGBOOST STOCK PREDICTOR - FIXED IMPLEMENTATION")
    print("="*80)
    ...
    # Formatting
    title = f'{STOCK_NAME} - XGBoost Buy Signals (Walk-Forward + Future)'
