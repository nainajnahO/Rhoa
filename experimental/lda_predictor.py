"""LDA Stock Predictor - Fixed Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_lda.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_lda.csv'
...
def main():
    ...
    final_model = LinearDiscriminantAnalysis(**LDA_PARAMS)
    ...
    ax.set_title(f'{STOCK_NAME} - LDA Buy Signals', fontsize=16, fontweight='bold', pad=20)
