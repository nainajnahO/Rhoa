"""Ridge Classifier Stock Predictor - Fixed Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_ridgeclassifier.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_ridgeclassifier.csv'
...
def walk_forward_validation(df, features, n_splits, min_train_size):
    ...
    for split_num in range(n_splits):
        ...
        print(f"Training RidgeClassifier model...")
        model = RidgeClassifier(**RIDGECLASSIFIER_PARAMS)
...
def main():
    print("="*80 + "\nSGD CLASSIFIER STOCK PREDICTOR\n" + "="*80)
    ...
    final_model = RidgeClassifier(**RIDGECLASSIFIER_PARAMS)
    ...
    ax.set_title(f'{STOCK_NAME} - RidgeClassifier Buy Signals', fontsize=16, fontweight='bold', pad=20)
