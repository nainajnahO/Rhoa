"""KNN Stock Predictor - Fixed Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_knn.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_knn.csv'
...
def main():
    ...
    final_model = KNeighborsClassifier(**KNN_PARAMS)
    ...
    ax.set_title(f'{STOCK_NAME} - KNN Buy Signals', fontsize=16, fontweight='bold', pad=20)
