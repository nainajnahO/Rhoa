"""QDA Stock Predictor - Fixed Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_qda.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_qda.csv'
...
def main():
    ...
    final_model = QuadraticDiscriminantAnalysis(**QDA_PARAMS)
    ...
    ax.set_title(f'{STOCK_NAME} - QDA Buy Signals', fontsize=16, fontweight='bold', pad=20)
