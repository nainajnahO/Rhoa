"""GRU Stock Predictor - TensorFlow/Keras Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_gru.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_gru.csv'

def create_sequences(X, y, timesteps):
    """Create sliding window sequences for GRU"""
...
def main():
    ...
    ax.set_title(f'{STOCK_NAME} - GRU Buy Signals', fontsize=16, fontweight='bold', pad=20)
