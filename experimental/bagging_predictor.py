"""Bagging Stock Predictor - Fixed Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_bagging.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_bagging.csv'
...
def main():
    ...
    final_model = BaggingClassifier(**BAGGING_PARAMS)
    ...
    ax.set_title(f'{STOCK_NAME} - Bagging Buy Signals', fontsize=16, fontweight='bold', pad=20)
