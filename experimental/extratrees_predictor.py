"""
ExtraTrees Stock Predictor - Fixed Implementation

This script trains an ExtraTrees model using proper time series validation to prevent data leakage.
...
Usage:
    python experimental/extratrees_predictor.py
"""
...
# ExtraTrees Hyperparameters (optimized for accuracy)
EXTRATREES_PARAMS = {
    'n_estimators': 300,
    'max_depth': 10,
    'min_samples_split': 5,
...
# Visualization
OUTPUT_PLOT_PATH = 'predictions_extratrees.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_extratrees.csv'
...
def main():
    print("="*80)
    print("EXTRATREES STOCK PREDICTOR - FIXED IMPLEMENTATION")
    print("="*80)
    ...
    # Formatting
    title = f'{STOCK_NAME} - ExtraTrees Buy Signals (Walk-Forward + Future)'
