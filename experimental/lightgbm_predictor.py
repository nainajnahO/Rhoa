"""
LightGBM Stock Predictor - Fixed Implementation

This script trains a LightGBM model using proper time series validation to prevent data leakage.
...
- LightGBM: Faster training and lower memory usage than XGBoost

Usage:
    python experimental/lightgbm_predictor.py
"""
...
LIGHTGBM_PARAMS = {
    ...
    'learning_rate': 0.05,
    'n_estimators': 300,
    'min_child_samples': 20,       # Similar to XGBoost's min_child_weight
...
# Visualization
OUTPUT_PLOT_PATH = 'predictions_lgbm.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_lgbm.csv'
...
def main():
    print("="*80)
    print("LIGHTGBM STOCK PREDICTOR - FIXED IMPLEMENTATION")
    print("="*80)
    ...
    final_model = lgb.LGBMClassifier(**LIGHTGBM_PARAMS)
    ...
    # Formatting
    title = f'{STOCK_NAME} - LightGBM Buy Signals (Walk-Forward + Future)'
