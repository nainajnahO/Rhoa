"""DecisionTree Stock Predictor - Fixed Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_decisiontree.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_decisiontree.csv'
...
def walk_forward_validation(df, features, n_splits, min_train_size):
    ...
    for split_num in range(n_splits):
        ...
        model = DecisionTreeClassifier(**DECISIONTREE_PARAMS)
...
def main():
    ...
    final_model = DecisionTreeClassifier(**DECISIONTREE_PARAMS)
    ...
    ax.set_title(f'{STOCK_NAME} - DecisionTree Buy Signals', fontsize=16, fontweight='bold', pad=20)
