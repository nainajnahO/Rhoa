"""HistGradientBoosting Stock Predictor - Fixed Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_histgradientboosting.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_histgradientboosting.csv'
...
def walk_forward_validation(df, features, n_splits, min_train_size):
    ...
    for split_num in range(n_splits):
        ...
        model = HistGradientBoostingClassifier(**HISTGRADIENTBOOSTING_PARAMS)
...
def main():
    print("="*80 + "\nHISTGRADIENTBOOSTING STOCK PREDICTOR\n" + "="*80)
    ...
    final_model = HistGradientBoostingClassifier(**HISTGRADIENTBOOSTING_PARAMS)
    ...
    ax.set_title(f'{STOCK_NAME} - HistGradientBoosting Buy Signals', fontsize=16, fontweight='bold', pad=20)
