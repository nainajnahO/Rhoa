"""
RandomForest Stock Predictor - Fixed Implementation

This script trains a RandomForest model using proper time series validation to prevent data leakage.
...
- RandomForest: Robust ensemble method, less prone to overfitting

Usage:
    python experimental/randomforest_predictor.py
"""
...
# RandomForest Hyperparameters (optimized for accuracy)
RANDOMFOREST_PARAMS = {
    'n_estimators': 300,
    'max_depth': 10,
    'min_samples_split': 5,
...
# Visualization
OUTPUT_PLOT_PATH = 'predictions_randomforest.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_randomforest.csv'
...
def main():
    print("="*80)
    print("RANDOMFOREST STOCK PREDICTOR - FIXED IMPLEMENTATION")
    print("="*80)
    ...
    final_model = RandomForestClassifier(**RANDOMFOREST_PARAMS)
    ...
    # Formatting
    title = f'{STOCK_NAME} - RandomForest Buy Signals (Walk-Forward + Future)'
