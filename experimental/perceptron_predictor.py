"""Perceptron Stock Predictor - Fixed Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_perceptron.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_perceptron.csv'
...
def walk_forward_validation(df, features, n_splits, min_train_size):
    ...
    for split_num in range(n_splits):
        ...
        print(f"Training Perceptron model...")
        model = Perceptron(**PERCEPTRON_PARAMS)
        model.fit(X_train_scaled, y_train)
        
        # Perceptron doesn't have predict_proba, use decision_function
...
def main():
    ...
    final_model = Perceptron(**PERCEPTRON_PARAMS)
    ...
    ax.set_title(f'{STOCK_NAME} - Perceptron Buy Signals', fontsize=16, fontweight='bold', pad=20)
