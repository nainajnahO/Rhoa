"""LSTM Stock Predictor - TensorFlow/Keras Implementation"""
import sys
...
OUTPUT_PLOT_PATH = 'predictions_lstm.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_lstm.csv'
...
def main():
    ...
    ax.set_title(f'{STOCK_NAME} - LSTM Buy Signals', fontsize=16, fontweight='bold', pad=20)
