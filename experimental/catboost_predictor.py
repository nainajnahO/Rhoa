"""
CatBoost Stock Predictor - Fixed Implementation

This script trains a CatBoost model using proper time series validation to prevent data leakage.
...
- CatBoost: Superior handling of categorical features and robust to overfitting

Usage:
    python experimental/catboost_predictor.py
"""
...
CATBOOST_PARAMS = {
    ...
    'thread_count': -1,
    'verbose': False,
    'allow_writing_files': False  # Suppress catboost_info directory
}

# Visualization
OUTPUT_PLOT_PATH = 'predictions_catboost.png'
OUTPUT_METRICS_PATH = 'walk_forward_metrics_catboost.csv'
...
def main():
    print("="*80)
    print("CATBOOST STOCK PREDICTOR - FIXED IMPLEMENTATION")
    print("="*80)
    ...
    # Formatting
    title = f'{STOCK_NAME} - CatBoost Buy Signals (Walk-Forward + Future)'
