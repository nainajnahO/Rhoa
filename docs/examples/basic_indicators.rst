...
.. code-block:: python
   ...
   df['SMA_50'] = df['Close'].indicators.sma(window_size=50)
   df['SMA_200'] = df['Close'].indicators.sma(window_size=200)
...
.. code-block:: python
   ...
   ema_12 = df['Close'].indicators.ewma(span=12)

   # Calculate 26-period EWMA
   ema_26 = df['Close'].indicators.ewma(span=26)
...
.. code-block:: python
   ...
   vol = df['Close'].indicators.ewmstd(span=20)
   df['Volatility'] = vol
...
.. code-block:: python
   ...
   vol_20 = df['Close'].indicators.ewmstd(span=20)
...
.. code-block:: python
   ...
   williams_r = df['Close'].indicators.williams_r(
       high=df['High'],
       low=df['Low'],
       window_size=14
   )
...
.. code-block:: python
   ...
   df['SMA_50'] = prices.indicators.sma(50)
   df['RSI'] = prices.indicators.rsi(14)
   df['EMA_12'] = prices.indicators.ewma(span=12)
   df['EMA_26'] = prices.indicators.ewma(span=26)
...
.. code-block:: python
   ...
   def create_indicator_dashboard(df):
       ...
       df['EMA_12'] = close.indicators.ewma(span=12)

       # Momentum indicators
       df['RSI_14'] = close.indicators.rsi(14)

       # Volatility
       df['Volatility'] = close.indicators.ewmstd(span=20)
